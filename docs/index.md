...
Beyond those two, documentation for a layer is written when that layer lands — a page describing code that does not exist is the failure mode the specification names — four documented behaviours the code never had.
